        ...
        <form method='post' action="{{route('payments.store')}}">
            ...
            <div class="row">
                <div class="col-md-6 col-12 mt-3">
                    ...
                    <input type='text' class="form-control @error('gu_id') is-invalid @enderror" id="gu_id" name="gu_id" value="{{old('gu_id')??''}}" required>
                    @error('gu_id')
                ...
                <div class="col-md-6 col-12 mt-3">
                    ...
                    <input type='text' class="form-control @error('ref_id') is-invalid @enderror" id="ref_id" name="ref_id" value="{{old('ref_id')??''}}" required>
                    @error('ref_id')
                        <span class="text-danger font-12">{{ $message }}</span>
                    @enderror
                </div>
