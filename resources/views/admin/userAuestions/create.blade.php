...
@section('content')
        <form method='post' action="{{route('userAuestions.store')}}">
            @csrf
            <div class="row">
                ...
                <div class="col-md-6 col-12 mt-3">
                    ...
                    <input type='text' class="form-control @error('answerd_at') is-invalid @enderror" id="answerd_at" name="answerd_at" value="{{old('answerd_at')??''}}" >
                    @error('answerd_at')
                        <span class="text-danger font-12">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-md-6 col-12 mt-3">
                    ...
                    <input type='text' class="form-control @error('answerd_by') is-invalid @enderror" id="answerd_by" name="answerd_by" value="{{old('answerd_by')??''}}" >
                    @error('answerd_by')
                        <span class="text-danger font-12">{{ $message }}</span>
                    @enderror
                </div>
