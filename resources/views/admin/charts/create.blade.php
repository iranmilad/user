        ...
        <form method='post' action="{{route('charts.store')}}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12 mt-3">
                    ...
                    <input type='number' class="form-control @error('refresh_time') is-invalid @enderror" id="refresh_time" name="refresh_time" value="{{old('refresh_time')??''}}" required>
                    @error('refresh_time')
                        <span class="text-danger font-12">{{ $message }}</span>
                    @enderror
                </div>             
                <div class="col-md-6 col-12 mt-3">
                    ...
                    <input type='text' class="form-control @error('feeder_url') is-invalid @enderror" id="feeder_url" name="feeder_url" value="{{old('feeder_url')??''}}" >
                    @error('feeder_url')
                        <span class="text-danger font-12">{{ $message }}</span>
                    @enderror
                </div>    
                 @include("admin.partials.subscribe-accessibility")
            </div>
