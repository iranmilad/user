...
@section('content')
  <div class="d-flex justify-content-between mb-3">
        <h5> فهرست نمودارها و جدول‌ها </h5>
        @if(auth()->user()->supper_admin)
         <a href="{{route('charts.create')}}" class="btn btn-info btn-sm mb-3 float-start">افزودن نمودارها و جدول جدید </a>
        @endif
            ...
            columns: [
                ...
                {"data": "feeder_url"},
                {
                 ...
                 {data:'created_at'},
                 {
                    ...
                    orderable: false,
                    render: function(data, type, row, meta) {
                        return  '<a href="'+baseUrl+'charts/'+row.id+'"><i class="bi bi-info-circle" title="نمایش" data-value="' + row.id + '" ></i></a>' +
                           ({{ auth()->user()->supper_admin }}? '<a href="'+baseUrl+'charts/'+row.id+'/edit"><i class="bi bi-pencil-square me-2 text-success" title="ویرایش" data-value="' + row.id + '" ></i></a>'
