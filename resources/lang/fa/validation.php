...
return [
    ...
    */
    'attributes' => [
        ...
        "village"=>"روستا",
        "village_en"=>"روستا انگلیسی",
        "village_ar"=>"روستا عربی",

        "address_en"=>"آدرس انگلیسی",
        "address_ar"=>"آدرس عربی",
        "building_type"=>"نوع ساختمان",
        "about_house"=>"درباره خانه",
        "about_house_en"=>"درباره خانه انگلیسی",
        "about_house_ar"=>"درباره خانه عربی",
        "structural_brigade"=>"تیپ سازه",
        "floor"=>"تعداد طبفات",
        "floor_unite"=>"طبقه واحد",
        "bedroom_num"=>"تعداد خواب",
        "building_area"=>"مساحت ساختمان",
        "land_area"=>"مساحت بنا",
        "standard_capacity"=>"ظرفیت استاندارد",
        "max_capacity"=>"حداکثر ظرفیت",
        "single_bed"=>"تعداد تخت یک نفره",
        "double_bed"=>"تعداد تخت دونفره",
        "location_desc"=>"توضیحات",
        "location_desc_en"=>"توضیحات انگلیسی",
        "location_desc_ar"=>"توضیحات عربی",
        "extra_desc"=>"جزئیات کامل",
        "extra_desc_en"=>"جزئیات کامل انگلیسی",
        "extra_desc_ar"=>"جزئیات کامل عربی",
        "enter_time"=>"ساعت ورود",
        "exit_time"=>"ساعت خروج",
        "min_reserve"=>"حداقل روز رزرو",
        "rule"=>"قوانین",
        "rule_en"=>"قوانین انگلیسی",
        "rule_ar"=>"قوانین عربی",
        "midWeek_price"=>"قیمت وسط هفته",
        "weekEnd_price"=>"قیمت آخر هفته",
        "pic_price"=>"قیمت ایام پیک",
        "extra_price"=>"قیمت نفر اضافه",
        "up_day1"=>"تخفیف رزرو طولانی یک",
        "percent1"=>"درصد تخفیف رزرو طولانی یک",
        "up_day2"=>"تخفیف رزرو طولانی دو",
        "percent2"=>"درصد تخفیف رزرو طولانی دو",

        "description_en"=>"توضیحات انگلیسی",
        "description_ar"=>"توضیحات عربی",
        "texture"=>"نوع بافت",
        "textures"=>"نوع بافت",
        "national_image" => "عکس کارت ملی",
        "code" => "کد",
        "discount" => "تخفیف",
    ],
];
